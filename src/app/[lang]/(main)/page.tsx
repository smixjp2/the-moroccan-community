          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 flex justify-center gap-4">
              <Button asChild size="lg" className="font-bold">
                <Link href={`/${params.lang}/articles`}>Explorer les Analyses <ArrowRight className="ml-2" /></Link>
              </Button>
              <Button asChild size="lg" variant="secondary" className="font-bold">
                <Link href={`/${params.lang}/tools`}>Voir les Outils</Link>
              </Button>
            </div>
          </div>
        </div>
              ...
              <Card key={feature.title} className="overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                ...
                <CardContent className="p-6">
                    ...
                    <Button asChild variant="link" className="px-0 mt-4 font-bold">
                        <Link href={`/${params.lang}${feature.link}`}>Découvrir <ArrowRight className="ml-2" /></Link>
                    </Button>
                </CardContent>
              </Card>
            ))}
