...
export default function DividendYieldCalculatorPage() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
        ...
        if (stockPrice <= 0) {
          throw new Error("Le prix de l'action doit être positif.");
        }
        ...
        setError(e.message || "Une erreur est survenue lors du calcul. Veuillez réessayer.");
        console.error(e);
    }
    setLoading(false);
  }
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input type="number" step="100" placeholder="50000" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
